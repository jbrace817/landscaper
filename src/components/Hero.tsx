...
export default function Hero() {
  return (
    <section className="relative mx-auto flex min-h-[95vh] pt-20">
      ...
      <LeafDecoration className="absolute top-32 right-[10%] h-32 w-32 rotate-[20deg] text-white/[0.05]" />
      <LeafDecoration className="absolute bottom-40 left-[5%] h-24 w-24 rotate-[-15deg] text-white/[0.03]" />
        ...
        <FadeIn>
          <div className="max-w-3xl xl:pb-20">
            ...
            <div className="mb-0 flex flex-col gap-4 sm:flex-row sm:items-center">
              <Button size="xl" className="group shadow-primary/30 shadow-lg">
                Get Your Free Quote
